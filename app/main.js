...
(function() {
  var BrowserWindow, Graph, Menu, app, buffer, dialog, doRender, fs, graph, ipcMain, lastB64, loadProject, mainWindow, newProject, nosmps, path, ready, renderEnd, renderPos, renderStart, rendering, reset, saveProject, settings, settingsPath, showGraph, showWaveform, stride, url, waveforms;
